...
const amenities = [
  ...
  },
  {
    ...
    image:
      "https://d274ft55l0imju.cloudfront.net/bus-api/fire_extinguisher.png",
  },
  {
    name: "First Aid Box",
    ...
    <div className={crd.card}>
      ...
      <div className={crd.busInfo}>
        <div className={`${crd.textLeft}`}>
          ...
          <h5 className={`${crd.overflow} ${crd.subHeadding}`}>
            AC Semi-Sleeper 2+2 Single Axle 2+2, Business Class Semi Sleeper,
            AC, LED
          </h5>
        </div>
      ...
      <div className={`${crd.AmWrapper}`}>
        ...
        >
          ...
          {amenities.length > 5 ? (
            <div
              style={{ color: "#00b8f8", fontSize: "14px", fontWeight: "700" }}
            >
              {amenities.length - 5}+
            </div>
          ) : null}
